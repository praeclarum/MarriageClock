 ...
 * @return success bool
 */
bool MyHTTPClient::begin(WiFiClient &client, String url) {
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
 ...
 * @return success bool
 */
bool MyHTTPClient::begin(WiFiClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool MyHTTPClient::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool MyHTTPClient::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool MyHTTPClient::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool MyHTTPClient::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool MyHTTPClient::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool MyHTTPClient::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 * @param reuse bool
 */
void MyHTTPClient::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void MyHTTPClient::setUserAgent(const String& userAgent)
{
 ...
 */
void MyHTTPClient::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void MyHTTPClient::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void MyHTTPClient::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void MyHTTPClient::setTimeout(uint16_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void MyHTTPClient::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int MyHTTPClient::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int MyHTTPClient::POST(String payload)
{
 ...
 * @return http code
 */
int MyHTTPClient::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int MyHTTPClient::PATCH(String payload)
{
 ...
 * @return http code
 */
int MyHTTPClient::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int MyHTTPClient::PUT(String payload) {
 ...
 * @return
 */
int MyHTTPClient::sendRequest(const char * type, String payload)
{
 ...
 */
int MyHTTPClient::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    // connect to server
    if(!connect()) {
 ...
 * @return WiFiClient
 */
WiFiClient& MyHTTPClient::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return WiFiClient*
 */
WiFiClient* MyHTTPClient::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int MyHTTPClient::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String MyHTTPClient::getString(void)
{
 ...
 * @return String
 */
String MyHTTPClient::errorToString(int error)
{
    switch(error) {
 ...
 * @param first
 */
void MyHTTPClient::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void MyHTTPClient::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String MyHTTPClient::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String MyHTTPClient::header(size_t i)
{
...
String MyHTTPClient::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int MyHTTPClient::headers()
{
    return _headerKeysCount;
}

bool MyHTTPClient::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool MyHTTPClient::connect(void)
{
    ...
    if (!_client) {
        log_d("MyHTTPClient::begin was not called or returned error");
        return false;
    }
 ...
 * @return status
 */
bool MyHTTPClient::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int MyHTTPClient::handleHeaderResponse()
{
 ...
 */
int MyHTTPClient::writeToStreamDataBlock(Stream * stream, int size)
{
    int buff_size = HTTP_TCP_BUFFER_SIZE;
    int len = size;
    int bytesWritten = 0;
 ...
 * @return error
 */
int MyHTTPClient::returnError(int error)
{
    if(error < 0) {
